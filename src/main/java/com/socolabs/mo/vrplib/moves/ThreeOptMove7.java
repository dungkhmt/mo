...
public class ThreeOptMove7 implements IVRPMove {
    ...
    public ThreeOptMove7(VRPVarRoutes vr, VRPPoint x, VRPPoint y, VRPPoint z, LexMultiValues eval) {
        this.vr = vr;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public void move() {
        ...
        vr.propagateThreeOptMove7(x, y, z);
    }
