...
public class ThreeOptMove3 implements IVRPMove {
    ...
    public ThreeOptMove3(VRPVarRoutes vr, VRPPoint x, VRPPoint y, VRPPoint z, LexMultiValues eval) {
        this.vr = vr;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public void move() {
        ...
        vr.propagateThreeOptMove3(x, y, z);
    }
