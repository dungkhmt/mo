...
public class CrossExchangeMove4 implements IVRPMove {
    ...
    public CrossExchangeMove4(VRPVarRoutes vr, VRPPoint x1, VRPPoint y1, VRPPoint x2, VRPPoint y2, LexMultiValues eval) {
        this.vr = vr;
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
