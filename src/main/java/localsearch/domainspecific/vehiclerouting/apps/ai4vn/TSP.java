	...
	public void interactiveRun(){
		...
		while(true){
			...
			if(cmd.equals("html")){
				...
				int y_id = Integer.valueOf(s[2].trim());
				Point x = mID2Point.get(x_id);
				Point y = mID2Point.get(y_id);
				...
				System.out.println("after move x = " + x.ID + ", y = " + y.ID + ", eval = " + eval + ", distance = " + totalDistance.getValue());
