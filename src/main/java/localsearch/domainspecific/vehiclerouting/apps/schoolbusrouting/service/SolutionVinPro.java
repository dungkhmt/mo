...
public class SolutionVinPro {
	...
	private double _nbBuses;
	
	public SolutionVinPro(VarRoutesVR XR, ArrayList<Point> rejectPoints, double cost, double nbBuses){
	...
	public double get_nbBuses() {
		return _nbBuses;
	}

	public void set_nbBuses(double nbBuses) {
		this._nbBuses = nbBuses;
	}
	...
	public void copy2RejectList(ArrayList<Point> rejectList){
		rejectList.clear();
		for(int i = 0; i < _rejectPoints.size(); i++){
			rejectList.add(_rejectPoints.get(i));
		}
	}
